...
class Places extends Component {
  ...
  renderPlaces(){
    ...
    return this.props.places.map((place => {
      return <PlaceListing key={place.name} place={place} />
    }))
  }
...
//whatever is returned will show up as props inside of places
//this is the connection between redux and the container
  return {
    places: state.places
  }
}
